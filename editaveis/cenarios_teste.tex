...
A partir do cenário \ref{sub:cen2}, a quantidade de partículas utilizadas foi fixada em 150 partículas, devido ao apresentado anteriormente.
...
\begin{table}[H]
\centering
\caption{Resultados Obtidos - Cenário 6}
\label{tab:cen6}
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\textbf{Ex.} & \textbf{Partículas} & \textbf{Rotação} & \textbf{Deslocamento} & \textbf{Ciclos} & \textbf{Posição}                                            & \textbf{Precisão} \\ \hline
...
A partir dos resultados obtidos durante a execução do cenário \ref{sub:cen6}, foi possível identificar que a quantidade de partículas
...
\begin{table}[H]
\centering
\caption{Resultados Obtidos - Cenário 7}
\label{tab:cen7}
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\textbf{Ex.} & \textbf{Partículas} & \textbf{Rotação} & \textbf{Deslocamento} & \textbf{Ciclos} & \textbf{Posição}                                            & \textbf{Precisão} \\ \hline
...
A partir dos resultados obtidos ao longo da execução do cenário \ref{sub:cen7}, observou-se que velocidades de rotação elevadas podem
...
\begin{table}[H]
\centering
\caption{Resultados Obtidos - Cenário 8}
\label{tab:cen8}
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\textbf{Ex.} & \textbf{Partículas} & \textbf{Rotação} & \textbf{Deslocamento} & \textbf{Ciclos} & \textbf{Posição}                                            & \textbf{Precisão} \\ \hline
...
A partir dos resultados obtidos com o cenário \ref{sub:cen8}, fixou-se a velocidade de deslocamento em 10 diâmetros por segundo, já que
foi obtido o melhor resultado com esta configuração. O cenário \ref{sub:cen9} apresenta o comportamento do robô utilizando a melhor
configuração obtida, de acordo com os 8 primeiro cenários de teste.


\subsection{Cenário de Teste 9}
\label{sub:cen9}
...
\begin{table}[H]
\centering
\caption{Resultados Obtidos - Cenário 9}
\label{tab:cen9}
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\textbf{Ex.} & \textbf{Partículas} & \textbf{Rotação} & \textbf{Deslocamento} & \textbf{Ciclos} & \textbf{Posição}                                            & \textbf{Precisão} \\ \hline
