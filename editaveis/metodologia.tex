\chapter[Metodologia]{Metodologia}
	...
	\begin{table}[H]
		...
		Exploratória                                                              & Qualitativa                                                              & \begin{tabular}[c]{@{}c@{}}Estudo de caso \\ único\end{tabular}      & \begin{tabular}[c]{@{}c@{}}Experimento/\\ pesquisa bibliográfica\end{tabular} & \begin{tabular}[c]{@{}c@{}}Análise de \\ conteúdo\end{tabular}       \\ \hline
		\end{tabular}
	\end{table}

	A partir da classificação de todas as categorias da pesquisa, deve-se estabelecer o \textit{caminho} a ser seguido para realização do trabalho, que está detalhado na seção \ref{sec:processo_metodológico}.
