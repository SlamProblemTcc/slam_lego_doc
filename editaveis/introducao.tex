...
\section{Justificativa}
	...
	\label{sec:organização_do_trabalho}
		...
		\begin{itemize}
			\item Introdução: Capítulo referente a contextualização, levantamento da questão de pesquisa, justificativa e definição dos objetivos do trabalho.
			...
			\item Metodologia: Este capítulo busca apresentar as técnicas utilizadas para a realização da pesquisa, definindo todo o \textit{caminho} percorrido durante este processo.
